...
VCF_TEMPLATE="vcf_template/vcf_template.vcf"
...
if [[ -f $HG_19 ]]; then
	echo "SUCCESS: hg19.2bit file downloaded and present in appropriate location"
else
...
if [[ -f $HG_38 ]]; then
	echo "SUCCESS: hg38.2bit file downloaded and present in appropriate location"
else
